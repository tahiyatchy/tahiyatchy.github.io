...
const scenarios = [
    {
        ...
        choices: [
            "Accept the director's help and start recruitment immediately",
            "Consult with your IRB about special protections needed",
            "Design a separate consent process with additional safeguards"
        ],
        feedback: [
            "This approach may create undue influence. Vulnerable populations require careful consideration of coercion risks.",
            "Good start! Consulting your IRB ensures you follow proper protocols for vulnerable populations.",
            "Proactive approach, but you should still consult your IRB before implementation."
        ]
    },
    {
        id: 2,
        title: "Data Privacy Dilemma",
        text: "Your research involves sensitive health data about mental health treatment. A collaborator asks for the raw dataset for their own analysis. What do you do?",
        choices: [
            "Share the data since they're a collaborator",
            "Only share anonymized summary statistics",
            "Request a formal data sharing agreement through your institution"
        ],
        feedback: [
            "Risky approach. Collaborators still need proper data sharing agreements for sensitive data.",
            "Good practice! Summary statistics protect privacy while enabling collaboration.",
            "Best approach! Formal agreements ensure proper data handling and compliance."
        ]
    },
    {
        id: 3,
        title: "Informed Consent Challenge",
        text: "You're studying medication adherence in elderly patients. Some participants seem confused about the consent form but agree to participate. How do you proceed?",
        choices: [
            "Proceed since they agreed verbally",
            "Use simplified consent materials and assess comprehension",
            "Exclude these participants from the study"
        ],
        feedback: [
            "Problematic. Verbal agreement doesn't ensure true informed consent.",
            "Excellent! Assessing comprehension ensures valid informed consent.",
            "May be appropriate but could exclude important voices. Consider enhanced consent procedures first."
        ]
    },
    {
        id: 4,
        title: "Conflict of Interest",
        text: "Your research is funded by a pharmaceutical company that could benefit from positive results. How do you address this in your study design?",
        choices: [
            "Proceed normally - funding doesn't affect research",
            "Disclose the funding in all publications",
            "Implement blinding and independent data analysis"
        ],
        feedback: [
            "Concerning. Financial conflicts must be actively managed.",
            "Good start, but disclosure alone isn't sufficient management.",
            "Best practice! Active management through blinding and independent analysis addresses the conflict."
        ]
    }
];
...
// Global variable for current scenario
...
function startScenario() {
    ...
    scenario.choices.forEach((choice, index) => {
        choicesHTML += `<div class="scenario-choice" onclick="selectScenarioChoice(${index})">${choice}</div>`;
    });
    ...
    document.getElementById('scenario-another').classList.add('hidden');
...
function selectScenarioChoice(choiceIndex) {
    ...
    const anotherButton = document.getElementById('scenario-another');
    ...
    feedbackElement.innerHTML = `
        ...
        <p>${scenario.feedback[choiceIndex]}</p>
        ${choiceIndex === 1 ? 
            ...
            '<p class="positive-feedback">✓ This is a strong ethical approach</p>'
        }
    `;
    
    feedbackElement.classList.remove('hidden');
    
    // Show the "Another Scenario" button instead of "Choose Another Scenario"
    anotherButton.classList.remove('hidden');
    resetButton.classList.add('hidden');
    
    // Connect the "Another Scenario" button
    anotherButton.onclick = getRandomScenario;
}

function getRandomScenario() {
    // Get a different random scenario
    let newIndex;
    do {
    ...
    // Hide feedback and show reset button
